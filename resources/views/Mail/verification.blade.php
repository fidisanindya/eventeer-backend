...
@section('content')
    ...
    <a href="{{ $details['link_to'] }}" style="background-color: #0057EE; padding: 8px 12px; border-radius: 8px; height: 33px; font-size: 14px; font-weight: 500; color: #FFFFFF; line-height: 17px; text-decoration: none; margin-bottom: 20px; border: none;">Verify email address</a>
