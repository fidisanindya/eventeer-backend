...
@section('content')
  ...
  <p style="line-height: 28px;">To reset your password, please insert this code below</p>
  ...
  <p style="line-height: 28px;">This OTP expires in 30 seconds. If you did not initiate this action, we highly advise that you change your password as soon as possible and also notify us by replying to this mail. <br> Thank you! </p>
@endsection