...
@section('content')
  ...
  <a href="{{ $details['token'] }}" style="background-color: #0057EE; padding: 8px 12px; border-radius: 8px; width: 153px; height: 33px; font-size: 14px; font-weight: 500; color: #FFFFFF; line-height: 17px; text-decoration: none;">Reset Password</a>
